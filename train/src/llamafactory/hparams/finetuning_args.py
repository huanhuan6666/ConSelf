...
class RLHFArguments:
    ...
    weak_base_model: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the reference model used for the WSPO training."},
    )
    weak_aligned_model: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the reference model used for the WSPO training."},
    )
...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    def __post_init__(self):
        ...
        self.use_ref_model = (self.stage == "dpo" or self.stage == "wspo" or self.stage == "condpo") and self.pref_loss not in ["orpo", "simpo"]
